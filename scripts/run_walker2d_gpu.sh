...
echo "================================================"
echo "Walker2d-v4 GPU Experiments (15 runs)"
...
echo ""
echo "================================================"
echo "All Walker2d-v4 experiments complete!"
echo "================================================"
echo ""
echo "Results saved to logs/logs_S_Walker2d-v4_*.npy"
echo ""
echo "Next steps:"
